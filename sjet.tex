...
Section~\ref{sec:void-mirror}: void and mirror axioms (the only axioms).
Section~\ref{sec:ladder}: mirror climb of the unified ladder.
...
Mirror $\Mirror$ primitive & Axiom & involutive climb & \ref{ax:void-mirror:mirror} \\
